...
import { canvases, products } from "@/utils/data";
import {
...
const Index: React.FC = () => {
  ...
  const handleProductPlacementChange = useCallback(
    (updatedPlacement: PlacedProduct) => {
  ...
  const handleDownload = async () => {
    if (placedProducts.length === 0) {
      toast({
        title: "No Products",
        description:
          "Please add at least one product to the canvas before downloading.",
        variant: "destructive",
      });
      return;
    }
      ...
      return {
        ...
        scale: {
          widthScale: parseFloat(
            (placement.width / placement.initialWidth).toFixed(2)
          ),
          heightScale: parseFloat(
            (placement.height / placement.initialHeight).toFixed(2)
          ),
        },
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-start">
                    <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-indigo-100 text-indigo-800 text-xs font-medium mr-2">
                      1
                    </span>
                  ...
                  <li className="flex items-start">
                    ...
                    Browse and click on products to add them to your canvas (max
                    3).
                  </li>
                  <li className="flex items-start">
                    <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-indigo-100 text-indigo-800 text-xs font-medium mr-2">
                  ...
                  <li className="flex items-start">
                    ...
                    Click "Download Composition" when you're satisfied with your
                    design.
                  </li>
                </ul>
              </div>
